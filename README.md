...
***NuLib***: A NuFile eXchange (**NuFX**) Archive Utility
(*also supporting* **_ShrinkIt_**/**_BinaryII_**)
...
* **NuLib2** (*at least out of the box*), doesn't attempt to support
  building on **MS-DOS**, **GS/OS**, or *most* other 16-bit platforms
  that were contemporary with the *Apple IIe*.
...
* This version of NuLib is known to be working on **CP/M-68000*,
  ...
  * While it *may* be possible to build **NuLib2** for these older systems,
...
* I *do* plan to incorporate any applicable changes from that release, **as**
...
* If you need to have **NuLib** working on the *Apple IIGS*, the upstream
  v3.25 is likely the best option and *probably* works as well as v3.24.
